...
urlpatterns = [
    ...
    url(r'^brokers/add/$', login_required(AddBrokerView.as_view()), name='add-broker'),
    url(r'^brokers/(?P<pk>[\w-]+)/update-broker/$', login_required(UpdateBrokerView.as_view()), name='update-broker'),
